...
public class AgregarNotasView extends JPanel {
    ...
    public AgregarNotasView() {
        ...
        // Etiqueta y combo box para Condición
        JLabel labelNota = new JLabel("Condición:");
        labelNota.setFont(generalFont);
        JComboBox<String> comboNota = new JComboBox<>();
        comboNota.setFont(generalFont);
        comboNota.setPreferredSize(viewUtils.getProportionalSize(0.3, 0.05)); // Tamaño dinámico
